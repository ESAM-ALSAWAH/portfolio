...
const SummaryCard = () => {
  return (
    <SectionCard>
      <div className="h-full flex flex-col sm:flex-row sm:items-center gap-5 sm:px-6 ">
        <div className="relative w-full max-w-48 mx-auto min-h-48 overflow-hidden rounded-tl-2xl rounded-br-2xl">
