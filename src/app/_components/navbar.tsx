  ...
  return (
    <div className="flex items-center justify-between py-5">
      <Link href="/" onClick={playClickAudio}>
        <img src="/images/logo.png" className="w-20 sm:w-28" />
      </Link>
      ...
      <div className="fixed bottom-0 left-0 right-0 items-center gap-4 flex md:hidden bg-[#1F1F1F] p-2 z-[90] border-t border-t-zinc-900 ">
        {links?.map((v) => (
          <Link
            key={v.href}
            href={v.href}
